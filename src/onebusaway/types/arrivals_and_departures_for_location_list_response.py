...
__all__ = [
    ...
    "ArrivalsAndDeparturesForLocationListResponseData",
    "ArrivalsAndDeparturesForLocationListResponseDataEntry",
    ...
    "ArrivalsAndDeparturesForLocationListResponseDataEntryArrivalsAndDepartureTripStatusPosition",
...
class ArrivalsAndDeparturesForLocationListResponseDataEntryArrivalsAndDepartureTripStatus(BaseModel):
    ...
    position: Optional[ArrivalsAndDeparturesForLocationListResponseDataEntryArrivalsAndDepartureTripStatusPosition] = (
        None
    )
    """Current position of the transit vehicle."""
...
class ArrivalsAndDeparturesForLocationListResponseDataEntryArrivalsAndDeparture(BaseModel):
    ...
    trip_status: Optional[ArrivalsAndDeparturesForLocationListResponseDataEntryArrivalsAndDepartureTripStatus] = (
...
class ArrivalsAndDeparturesForLocationListResponseDataEntryNearbyStopID(BaseModel):
    distance_from_query: Optional[float] = FieldInfo(alias="distanceFromQuery", default=None)
...
class ArrivalsAndDeparturesForLocationListResponseDataEntry(BaseModel):
    arrivals_and_departures: List[ArrivalsAndDeparturesForLocationListResponseDataEntryArrivalsAndDeparture] = (
        FieldInfo(alias="arrivalsAndDepartures")
    )

    limit_exceeded: bool = FieldInfo(alias="limitExceeded")

    nearby_stop_ids: List[ArrivalsAndDeparturesForLocationListResponseDataEntryNearbyStopID] = FieldInfo(
        alias="nearbyStopIds"
    )
