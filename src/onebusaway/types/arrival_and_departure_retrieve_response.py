...
class ArrivalAndDepartureRetrieveResponseDataEntryTripStatus(BaseModel):
    ...
    last_known_location: Optional[ArrivalAndDepartureRetrieveResponseDataEntryTripStatusLastKnownLocation] = FieldInfo(alias = "lastKnownLocation", default = None)
...
class ArrivalAndDepartureRetrieveResponseDataEntry(BaseModel):
    ...
    trip_status: Optional[ArrivalAndDepartureRetrieveResponseDataEntryTripStatus] = FieldInfo(alias = "tripStatus", default = None)
