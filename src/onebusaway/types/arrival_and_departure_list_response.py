...
class ArrivalAndDepartureListResponseDataEntryArrivalsAndDepartureTripStatus(BaseModel):
    ...
    last_known_location: Optional[ArrivalAndDepartureListResponseDataEntryArrivalsAndDepartureTripStatusLastKnownLocation] = FieldInfo(alias = "lastKnownLocation", default = None)
...
class ArrivalAndDepartureListResponseDataEntryArrivalsAndDeparture(BaseModel):
    ...
    trip_status: Optional[ArrivalAndDepartureListResponseDataEntryArrivalsAndDepartureTripStatus] = FieldInfo(alias = "tripStatus", default = None)
    """Trip-specific status for the arriving transit vehicle."""

class ArrivalAndDepartureListResponseDataEntry(BaseModel):
    arrivals_and_departures: List[ArrivalAndDepartureListResponseDataEntryArrivalsAndDeparture] = FieldInfo(alias = "arrivalsAndDepartures")
