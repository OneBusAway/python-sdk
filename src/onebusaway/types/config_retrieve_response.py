...
__all__ = ["ConfigRetrieveResponse", "ConfigRetrieveResponseData", "ConfigRetrieveResponseDataEntry", "ConfigRetrieveResponseDataEntryGitProperties"]
...
class ConfigRetrieveResponseDataEntry(BaseModel):
    ...
    git_properties: Optional[ConfigRetrieveResponseDataEntryGitProperties] = FieldInfo(alias = "gitProperties", default = None)
