...
__all__ = [
    ...
    "SearchForRouteRetrieveResponseData",
    "SearchForRouteRetrieveResponseDataList",
]
...
class SearchForRouteRetrieveResponseData(BaseModel):
    limit_exceeded: bool = FieldInfo(alias="limitExceeded")

    list: List[SearchForRouteRetrieveResponseDataList]
...
class SearchForRouteRetrieveResponse(ResponseWrapper):
