...
class ScheduleForStopRetrieveResponseDataEntryStopRouteScheduleStopRouteDirectionSchedule(BaseModel):
    schedule_stop_times: List[ScheduleForStopRetrieveResponseDataEntryStopRouteScheduleStopRouteDirectionScheduleScheduleStopTime] = FieldInfo(alias = "scheduleStopTimes")

    trip_headsign: str = FieldInfo(alias = "tripHeadsign")

    schedule_frequencies: Optional[List[ScheduleForStopRetrieveResponseDataEntryStopRouteScheduleStopRouteDirectionScheduleScheduleFrequency]] = FieldInfo(alias = "scheduleFrequencies", default = None)

class ScheduleForStopRetrieveResponseDataEntryStopRouteSchedule(BaseModel):
    route_id: str = FieldInfo(alias = "routeId")

    stop_route_direction_schedules: List[ScheduleForStopRetrieveResponseDataEntryStopRouteScheduleStopRouteDirectionSchedule] = FieldInfo(alias = "stopRouteDirectionSchedules")
...
class ScheduleForStopRetrieveResponseDataEntry(BaseModel):
    ...
    stop_route_schedules: List[ScheduleForStopRetrieveResponseDataEntryStopRouteSchedule] = FieldInfo(alias = "stopRouteSchedules")
