...
class TestTripsForLocation:
    ...
    def test_method_retrieve(self, client: OnebusawaySDK) -> None:
        trips_for_location = client.trips_for_location.retrieve(
            lat=0,
            lat_span=0,
            lon=0,
            lon_span=0,
        )
        assert_matches_type(TripsForLocationRetrieveResponse, trips_for_location, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: OnebusawaySDK) -> None:
        response = client.trips_for_location.with_raw_response.retrieve(
            lat=0,
            lat_span=0,
            lon=0,
            lon_span=0,
    ...
    def test_streaming_response_retrieve(self, client: OnebusawaySDK) -> None:
        with client.trips_for_location.with_streaming_response.retrieve(
            lat=0,
            lat_span=0,
            lon=0,
            lon_span=0,
...
class TestAsyncTripsForLocation:
    ...
    async def test_method_retrieve(self, async_client: AsyncOnebusawaySDK) -> None:
        trips_for_location = await async_client.trips_for_location.retrieve(
            lat=0,
            lat_span=0,
            lon=0,
            lon_span=0,
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncOnebusawaySDK) -> None:
        response = await async_client.trips_for_location.with_raw_response.retrieve(
            lat=0,
            lat_span=0,
            lon=0,
            lon_span=0,
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncOnebusawaySDK) -> None:
        async with async_client.trips_for_location.with_streaming_response.retrieve(
            lat=0,
            lat_span=0,
            lon=0,
            lon_span=0,
