...
class TestSearchForRoute:
    ...
    def test_method_retrieve(self, client: OnebusawaySDK) -> None:
        search_for_route = client.search_for_route.retrieve(
            input="input",
        )
    ...
    def test_raw_response_retrieve(self, client: OnebusawaySDK) -> None:
        response = client.search_for_route.with_raw_response.retrieve(
            input="input",
        )
    ...
    def test_streaming_response_retrieve(self, client: OnebusawaySDK) -> None:
        with client.search_for_route.with_streaming_response.retrieve(
            input="input",
        ) as response:
