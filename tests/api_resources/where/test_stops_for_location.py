...
class TestStopsForLocation:
    ...
    def test_method_list(self, client: OpenTransit) -> None:
        stops_for_location = client.where.stops_for_location.list(
            key="string",
        )
    ...
    def test_raw_response_list(self, client: OpenTransit) -> None:
        response = client.where.stops_for_location.with_raw_response.list(
            key="string",
        )
    ...
    def test_streaming_response_list(self, client: OpenTransit) -> None:
        with client.where.stops_for_location.with_streaming_response.list(
            key="string",
        ) as response:
...
class TestAsyncStopsForLocation:
    ...
    async def test_method_list(self, async_client: AsyncOpenTransit) -> None:
        stops_for_location = await async_client.where.stops_for_location.list(
            key="string",
        )
        assert_matches_type(StopsForLocationListResponse, stops_for_location, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncOpenTransit) -> None:
        response = await async_client.where.stops_for_location.with_raw_response.list(
            key="string",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncOpenTransit) -> None:
        async with async_client.where.stops_for_location.with_streaming_response.list(
            key="string",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
