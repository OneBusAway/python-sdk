...
class TestAgenciesWithCoverage:
    ...
    def test_method_list(self, client: OpenTransit) -> None:
        agencies_with_coverage = client.where.agencies_with_coverage.list()
    ...
    def test_raw_response_list(self, client: OpenTransit) -> None:
        response = client.where.agencies_with_coverage.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: OpenTransit) -> None:
        with client.where.agencies_with_coverage.with_streaming_response.list() as response:
...
class TestAsyncAgenciesWithCoverage:
    ...
    async def test_method_list(self, async_client: AsyncOpenTransit) -> None:
        agencies_with_coverage = await async_client.where.agencies_with_coverage.list()
        assert_matches_type(AgenciesWithCoverageListResponse, agencies_with_coverage, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncOpenTransit) -> None:
        response = await async_client.where.agencies_with_coverage.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncOpenTransit) -> None:
        async with async_client.where.agencies_with_coverage.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
