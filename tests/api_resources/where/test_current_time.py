...
class TestCurrentTime:
    ...
    def test_method_retrieve(self, client: OpenTransit) -> None:
        current_time = client.where.current_time.retrieve()
    ...
    def test_raw_response_retrieve(self, client: OpenTransit) -> None:
        response = client.where.current_time.with_raw_response.retrieve()
    ...
    def test_streaming_response_retrieve(self, client: OpenTransit) -> None:
        with client.where.current_time.with_streaming_response.retrieve() as response:
...
class TestAsyncCurrentTime:
    ...
    async def test_method_retrieve(self, async_client: AsyncOpenTransit) -> None:
        current_time = await async_client.where.current_time.retrieve()
        assert_matches_type(CurrentTimeRetrieveResponse, current_time, path=["response"])

    @parametrize
    async def test_raw_response_retrieve(self, async_client: AsyncOpenTransit) -> None:
        response = await async_client.where.current_time.with_raw_response.retrieve()
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncOpenTransit) -> None:
        async with async_client.where.current_time.with_streaming_response.retrieve() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
