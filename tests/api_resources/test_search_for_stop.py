...
class TestSearchForStop:
    ...
    def test_method_retrieve(self, client: OnebusawaySDK) -> None:
        search_for_stop = client.search_for_stop.retrieve(
            input="input",
        )
    ...
    def test_raw_response_retrieve(self, client: OnebusawaySDK) -> None:
        response = client.search_for_stop.with_raw_response.retrieve(
            input="input",
        )
    ...
    def test_streaming_response_retrieve(self, client: OnebusawaySDK) -> None:
        with client.search_for_stop.with_streaming_response.retrieve(
            input="input",
        ) as response:
